...
def parse_args(args=None):
    ...
    parser.add_argument( # for dataset
        ...
        choices=["knowledge_memorization","knowledge_understanding","longform_qa",
                        "finance_qa","hotpotqa","lcc", "multi_news", "qmsum","alpacafarm", "all", "repobench-p"],
    )
    ...
    parser.add_argument(
        ...
        help="Path to the sentence transformer model for semantic similarity calculation.",
    )
...
def get_pred(watermark_args, model, tokenizer, data, max_length, max_gen, prompt_format, dataset, device, model_name, save_dir: str = None, debug: bool = False):
    preds = []
    from generate_chunk_semsim import ChunkSearchGenerator
