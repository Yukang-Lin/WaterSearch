...
class WatermarkBase:
    def __init__(
        ...
        self.hash_key = 15485863 * hash_seed
    ...
    def _get_greenlist_ids(self, input_ids: torch.LongTensor) -> list[int]:
        ...
        if self.select_green_tokens: # directly
            ...
            self.blacklist_ids = vocab_permutation[greenlist_size:]
        else: # select green via red
            greenlist_ids = vocab_permutation[(self.vocab_size - greenlist_size) :]  # legacy behavior
            self.blacklist_ids = vocab_permutation[:(self.vocab_size - greenlist_size)]
...
class WatermarkLogitsProcessor(WatermarkBase, LogitsProcessor):
    ...
    def __call__(self, input_ids: torch.LongTensor, scores: torch.FloatTensor) -> torch.FloatTensor:
        ...
        return scores, self.blacklist_ids
    ...
    def _score_sequence(
        ...
        if self.ignore_repeated_bigrams:
            ...
            for idx in range(self.min_prefix_len, len(input_ids)):
                ...
                tok_in_ph_gl = curr_token in greenlist_ids
                ...
                if debug:
                    decoded_token = self.tokenizer.decode(curr_token, skip_special_tokens=True)
                    print(f"Token generated: '{decoded_token}' was in the blacklist {tok_in_ph_gl}")
                    print("curr_token decode is: ", decoded_token)
